    ...
    list.forEach((m, i) => {
      html += `<div class="meal" data-day="${d}" data-index="${i}">
        ...
        <div class="meal-actions">
          <button class="replace-btn" data-day="${d}" data-index="${i}">🔄</button>
          <button class="remove-btn" data-day="${d}" data-index="${i}">✖</button>
        </div>
      </div>`;
    });
...
export function initMealPlan(db) {
  ...
  document.getElementById('exportShopListBtn').addEventListener('click', exportShopList);
